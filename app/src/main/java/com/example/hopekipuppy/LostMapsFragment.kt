...
class LostMapsFragment : Fragment() {
    ...
    private val callback = OnMapReadyCallback { googleMap ->
        ...
        if (!requireArguments().getString("addr").isNullOrEmpty()) {
            ...
            if(addressList!!.isNotEmpty()) {
                ...
                WriteLostFragment.lat = latitude
                WriteLostFragment.long = longitude
                WriteLostFragment.addr = addr
                ...
                googleMap.setOnMarkerDragListener(object : GoogleMap.OnMarkerDragListener {
                    ...
                    override fun onMarkerDragEnd(arg0: Marker) {
                        ...
                        WriteLostFragment.lat = position.latitude
                        WriteLostFragment.long = position.longitude
                        ...
                        WriteLostFragment.addr = addressList!![0].getAddressLine(0) ?:"error"
                    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_lost_maps, container, false)
    }
